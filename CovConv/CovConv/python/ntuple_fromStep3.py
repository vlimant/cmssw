...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --runUnscheduled --mc --conditions auto:run1_mc --filein step3.root --no_exec
...
process.load("CovConv.CovConv.covConv")
